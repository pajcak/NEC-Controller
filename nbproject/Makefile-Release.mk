...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sagecontroller

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sagecontroller: ${OBJECTFILES}
...
${OBJECTDIR}/CConnection.o: CConnection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CConnection.o CConnection.cpp
...
${OBJECTDIR}/CHeader.o: CHeader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CHeader.o CHeader.cpp

${OBJECTDIR}/CPacket.o: CPacket.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPacket.o CPacket.cpp

${OBJECTDIR}/MsgIncoming.o: MsgIncoming.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MsgIncoming.o MsgIncoming.cpp

${OBJECTDIR}/MsgOutgoing.o: MsgOutgoing.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sagecontroller
